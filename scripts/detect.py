...
class ColorDetector:
    ...
    def detect_colors(self, frame: np.ndarray):
        ...
        cv2.imshow("1.Yellow Binary", yellow_binary)
        ...
        cv2.imshow("2.Yellow Mask", yellow_mask)
        ...
        cv2.imshow("3.Inv Yellow Binary", inv_yellow_binary)

        object_frame = cv2.bitwise_and(yellow_mask, inv_yellow_binary)
        cv2.imshow("4.Object Frame", object_frame)
    ...
    def run(self) -> None:
        ...
        while True:
            ...
            # Display results
            cv2.imshow("5.Result Frame", frame)
